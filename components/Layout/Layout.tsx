    ...
    return (
        <ComSafeAreaView style={{ backgroundColor: '#fff' }}>
            ...
            {!noBottom && setSelectedPage && (
                <View
                    className="bg-black flex flex-row p-3 justify-around mx-2 mb-2 rounded-full "
