...
const Layout = ({ children, canBack, noBottom, selected, setSelectedPage }: TLayoutProps) => {
    useEffect(() => {
    ...
    return (
        <ComSafeAreaView style={{ backgroundColor: '#fff' }}>
            <View className="w-full flex p-[12px] flex-row items-center justify-center relative">
                {canBack && (
                    <TouchableOpacity
                        onPress={() => {
                            navigation.goBack();
            ...
            {!noBottom && setSelectedPage && (
                <View className="bg-white flex flex-row py-3 justify-around" style={Platform.OS == "android" && mixins.shadow}>
                    <TouchableOpacity
                        ...
                        disabled={selected == 0}
                        className={`flex items-center justify-center gap-y-[5px] min-w-[70px]`}
                    >
                        <View
                            className={`${selected == 0 ? 'bg-[#8E97FD]' : 'bg-white'} p-[12px] rounded-[18px]`}
                        >
                        ...
                        <Text
                            className={`font-Comfortaa text-[#A0A3B1] ${selected == 0 && 'text-[#8E97FD]'}`}
                        >
                            Главная
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                        <View
                            className={`${selected == 1 ? 'bg-[#8E97FD]' : 'bg-white'} p-[12px] rounded-[18px]`}
                        >
                        ...
                        <Text
                            className={`font-Comfortaa text-[#A0A3B1] ${selected == 1 && 'text-[#8E97FD]'}`}
                        >
                            Сон
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                        <View
                            className={`${selected == 2 ? 'bg-[#8E97FD]' : 'bg-white'} p-[12px] rounded-[18px]`}
                        >
                        ...
                        <Text
                            className={`font-Comfortaa text-[#A0A3B1] ${selected == 2 && 'text-[#8E97FD]'}`}
                        >
                            Помощник
                        </Text>
                    </TouchableOpacity>
                    ...
                    >
                        <View
                            className={`${selected == 3 ? 'bg-[#8E97FD]' : 'bg-white'} p-[12px] rounded-[18px]`}
                        >
                        ...
                        <Text
                            className={`font-Comfortaa text-[#A0A3B1] ${selected == 3 && 'text-[#8E97FD]'}`}
                        >
                            Музыка
                        </Text>
                    </TouchableOpacity>
                    ...
                    <TouchableOpacity
                        onPress={() => setSelectedPage(4)}
                        disabled={selected == 4}
                        className="flex items-center justify-center gap-y-[5px] min-w-[70px]"
                    >
                        <View
                            className={`${selected == 4 ? 'bg-[#8E97FD]' : 'bg-white'} p-[12px] rounded-[18px]`}
                        >
                        ...
                        <Text
                            className={`font-Comfortaa text-[#A0A3B1] ${selected == 4 && 'text-[#8E97FD]'}`}
                        >
                            Профиль
                        </Text>
                    </TouchableOpacity>
