...
const TopCard = ({image, title, subtitle, time_first, time_second, classNames}) => (
    <View className={`rounded-xl min-h-[210px] ${classNames}`} style={{ width: (Dimensions.get("screen").width / 2) - 20 - 15 }}>
