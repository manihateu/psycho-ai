import { View, Text, Dimensions, TouchableOpacity, ScrollView, ImageBackground } from "react-native"
    ...
    return (
        <ScrollView className="py-3">
            <View className="w-full flex flex-row justify-around">
                <TouchableOpacity className="rounded-3xl p-3 shandow bg-white" style={[{minWidth: Dimensions.get('window').width / 2 - 16}, mixins.shadow]}>
                    <View className="flex flex-row">
                        <Image source={{uri: "https://a.d-cd.net/10e9348s-960.jpg"}} className="w-[64px] h-[64px] rounded-full flex items-center justify-center"/>
                ...
                <View className="rounded-3xl p-3 shandow bg-white bg-[#8E97FD] flex justify-center" style={[{minWidth: Dimensions.get('window').width / 2 - 16}, mixins.shadow]}>
            ...
            <View className="w-full flex flex-row justify-around mt-3">
                <TouchableOpacity className="rounded-3xl p-3 shandow bg-white relative" style={[{minWidth: Dimensions.get('window').width / 2 - 16, minHeight: 150}, mixins.shadow]}>
                    <Like width={32} height={32} style={{marginLeft: 'auto'}}/>
                    <Text className="font-Comfortaa mt-auto ">Понравившиеся</Text>
                </TouchableOpacity>
                <TouchableOpacity className="rounded-3xl p-3 shandow bg-white " style={[{minWidth: Dimensions.get('window').width / 2 - 16, minHeight: 150}, mixins.shadow]}>
                    <Listening width={32} height={32} style={{marginLeft: 'auto'}}/>
                    <Text className="font-Comfortaa mt-auto  ">История</Text>
                </TouchableOpacity>

            </View>
            <TouchableOpacity className="rounded-3xl p-5 flex flex-row items-center shandow bg-white mx-[8px] mt-3" style={[{minWidth: Dimensions.get('window').width / 2 - 32}, mixins.shadow]}>
            ...
            <TouchableOpacity onPress={quitHandler} className="rounded-3xl p-5 flex flex-row items-center shandow bg-white mx-[8px] mt-3 bg-red-400" style={[{minWidth: Dimensions.get('window').width / 2 - 32}, mixins.shadow]}>
