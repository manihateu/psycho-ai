    ...
    return (
        <ComSafeAreaView className="bg-white">
            ...
            >
                <TouchableOpacity
                    onPress={goBack}
                    className="absolute rounded-full border border-[1px] top-[20px] border-[#EBEAEC] w-[55px] h-[55px] z-[999] bg-white top-[20px] left-[20px] flex justify-center items-center"
                >
                ...
                <View className="px-[20px]">
                    ...
                    <ComButton
                        ...
                        size="medium"
                    />
                    <Text className="font-Comfortaa mt-[20px] underline text-center">
                        Забыли пароль?
                    </Text>
                </View>
                <View className="flex flex-row w-full px-1 justify-center mt-auto mb-[60px]">
                    <Text className="font-Comfortaa text-gray-400 mr-2">Еще нет аккаунта?</Text>
                    <Pressable onPress={() => {}}>
                        <Text className="font-Comfortaa text-blue-600">Зарегистрироваться</Text>
                    </Pressable>
                </View>
            </Pressable>
        </ComSafeAreaView>
